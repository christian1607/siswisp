            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="panel-heading">
                        <label>FORMULARIO: AGREGAR EQUIPO</label>
                    </div>
                    <sp:form  role="form" modelAttribute="equipo" action="create" >
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <sp:input path="mac" type="text" class="form-control " placeholder="Ejm: 00:A2:BC:34:12:8C" /> 
                                            </div>
                                        </div> 
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <sp:input path="ip" type="text" class="form-control " placeholder="Ejem: 192.168.1.123" /> 
                                            </div>
                                        </div> 
                                    </div>

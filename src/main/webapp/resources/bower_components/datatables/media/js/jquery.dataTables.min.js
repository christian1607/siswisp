...
oPaginate:{sFirst:"Primero",sLast:"Atrás",sNext:"Siguiente",sPrevious:"Atrás"},sEmptyTable:"No se encontraron datos ",sInfo:"Mostrando _START_ de _END_ filas de un total de _TOTAL_ registros ",sInfoEmpty:"No se encontro nada",sInfoFiltered:"(Filtrado de  un total de _MAX_ entradas)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar cada _MENU_ filas",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No se encontraron resultados"},oSearch:h.extend({},
